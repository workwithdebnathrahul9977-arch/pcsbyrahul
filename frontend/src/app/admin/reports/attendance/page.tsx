    ...
    <div className="max-w-[1600px] mx-auto font-sans">
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-slate-500 text-sm mt-0.5">Track student presence, absences, and overall attendance metrics.</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden mb-6">
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div>
            ...
            <input type="month" className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500" />
          </div>
          <div className="flex items-end gap-2">
            <button className="flex-1 bg-blue-600 hover:bg-blue-700 text-white rounded-lg py-2 text-sm font-bold shadow-sm transition-all flex items-center justify-center gap-2">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-12 flex flex-col items-center justify-center text-center min-h-[400px]">
        <i className="fa-solid fa-clipboard-user text-6xl text-slate-200 mb-4"></i>
        <h3 className="text-lg font-bold text-slate-700">No Data Available</h3>
        <p className="text-slate-500 text-sm max-w-sm mt-1">Please select the required filters to load the attendance report.</p>
      </div>
    </div>
  );
}
