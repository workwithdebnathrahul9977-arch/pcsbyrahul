  ...
  return (
    <div className="max-w-[1600px] mx-auto font-sans">
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-black text-slate-900 tracking-tight">Result Reports</h1>
          <p className="text-slate-500 text-sm mt-0.5">Analyze and export exam marks, rankings, and performance data.</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden mb-6">
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-4 gap-4">
          <div>
            ...
            <select className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-purple-500">
          ...
          <div className="flex items-end gap-2">
            <button className="flex-1 bg-purple-600 hover:bg-purple-700 text-white rounded-lg py-2 text-sm font-bold shadow-sm transition-all flex items-center justify-center gap-2">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-12 flex flex-col items-center justify-center text-center min-h-[400px]">
        <i className="fa-solid fa-file-contract text-6xl text-slate-200 mb-4"></i>
        <h3 className="text-lg font-bold text-slate-700">No Exam Selected</h3>
        <p className="text-slate-500 text-sm max-w-sm mt-1">Please select batch and exam to load the results sheet.</p>
      </div>
    </div>
  );
}
